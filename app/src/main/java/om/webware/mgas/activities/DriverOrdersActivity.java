...
public class DriverOrdersActivity extends DriverDrawerBaseActivity implements OrdersRecyclerAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewTitle.setText(getString(R.string.request_history));
